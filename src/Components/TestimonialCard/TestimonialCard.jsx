...
const TestimonialCard = () => {
    return (
        <div className=" mx-auto py-16 w-11/12 md:w-9/12">
             <div className="text-center mb-10">
                <h2 className="text-3xl md:text-4xl font-bold ">What Our  <span className='text-orange-600'>Customers</span> Say</h2>
                <p className=" mt-3">Hear from our satisfied users who have experienced reliable and professional services with HomeHero.</p>
            </div>
            <div className='w-full border border-orange-200 shadow-2xl rounded-2xl md:p-10 p-5'>
                <h1 className=' text-xl text-justify'>HomeHero connected me with a trustworthy electrician in no time. The service was incredibly professional, fast, and reliable. From the moment I booked the appointment, everything was smooth and hassle-free. The electrician arrived on time, handled the job efficiently, and even offered helpful tips to prevent future issues. I truly felt supported and confident in the quality of service provided, making the whole experience completely stress-free and satisfying.</h1>
                ...
                <div className='mt-8 pl-10 flex items-center gap-3'>
                    ...
                    <div>
                        ...
                        <p className=" text-sm mb-2">Homeowner</p>
                    </div>
                </div>
            </div>
        </div>
